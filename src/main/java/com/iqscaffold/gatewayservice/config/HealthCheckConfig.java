...
public class HealthCheckConfig {
  ...
  public ReactiveHealthIndicator userServiceHealthIndicator(WebClient.Builder webClientBuilder,
    ...
    return new UserServiceHealthIndicator(webClientBuilder, properties);
  }
  ...
  public static class UserServiceHealthIndicator implements ReactiveHealthIndicator {
    ...
    public UserServiceHealthIndicator(final WebClient.Builder webClientBuilder, final IqScaffoldProperties properties) {
      this.userServiceUrl = properties.gateway().security().authentication().userServiceUrl();
