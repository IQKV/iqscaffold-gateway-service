...
public class StructuredLoggingConfig {
  ...
  public static class RequestLogger {
    ...
    private static final Logger requestLogger = LoggerFactory.getLogger("com.iqscaffold.gatewayservice.request");
  ...
  public static class PerformanceLogger {
    ...
    private static final Logger performanceLogger = LoggerFactory.getLogger("com.iqscaffold.gatewayservice.performance");
