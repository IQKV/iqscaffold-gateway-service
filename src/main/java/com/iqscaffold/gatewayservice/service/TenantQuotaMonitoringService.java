...
/**
 * Service for monitoring tenant quota usage and alerting. Tracks tenant usage patterns and provides quota monitoring capabilities.
 */
@Service
public class TenantQuotaMonitoringService {
  ...
  public TenantQuotaMonitoringService(final IqScaffoldProperties properties, final ReactiveStringRedisTemplate redisTemplate) {
  ...
  public static class TenantUsageStats {
    ...
    public Map<String, Long> getEndpointCounts() {
      return Map.copyOf(endpointCounts);
    }
